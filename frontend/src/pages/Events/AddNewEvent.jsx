...
export default function AddNewEvent() {
  ...
  // Update Plyr poster when thumbnailPreviewUrl changes - Not needed here as Plyr is not used for preview in this component
  // useEffect(() => {
          ...
          formData,
          {
            ...
            onUploadProgress: (progressEvent) => {
              ...
              if (totalSize > 0 && loaded >= 0) {
                ...
                console.warn(
                  "Upload progress total size unknown or invalid.",
                  { loaded, total: totalSize }
                );
                // Handle indeterminate progress if desired (e.g., set to 1 if loaded > 0)
              }

              percentCompleted = Math.min(
                Math.max(percentCompleted, 0),
                100
              ); // Clamp 0-100
                ...
                <div className="mt-2 flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                  ...
                  <div className="text-center">
                    ...
                    <label
                      ...
                      style={{ WebkitTapHighlightColor: 'transparent' }} // ADDED iOS tap highlight fix
                    >
                      <span>
